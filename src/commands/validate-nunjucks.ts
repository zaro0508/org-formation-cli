...
import { IUpdateNunjucksCommandArgs, UpdateNunjucksCommand } from './update-nunjucks';
...
export class ValidateStacksCommand extends BaseCliCommand<IUpdateNunjucksCommandArgs> {
