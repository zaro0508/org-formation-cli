...
const commandName = 'update-nunjucks <templateFile>';
const commandDescription = 'update CloudFormation resources in accounts';

export class UpdateNunjucksCommand extends BaseCliCommand<IUpdateNunjucksCommandArgs> {

    public static async Perform(command: IUpdateNunjucksCommandArgs): Promise<void> {
        const x = new UpdateNunjucksCommand();
        await x.performCommand(command);
    }

    public static createTemplateUsingOverrides(command: IUpdateNunjucksCommandArgs, templateFile: string): TemplateRoot {
    ...
    public async performCommand(command: IUpdateNunjucksCommandArgs): Promise<void> {
        ...
        const template = UpdateNunjucksCommand.createTemplateUsingOverrides(command, templateFile);
...
export interface IUpdateNunjucksCommandArgs extends ICommandArgs {
