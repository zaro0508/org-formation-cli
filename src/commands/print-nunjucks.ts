...
import { UpdateNunjucksCommand, IUpdateNunjucksCommandArgs } from './update-nunjucks';
...
export class PrintStacksCommand extends BaseCliCommand<IPrintStacksCommandArgs> {
    ...
    public async performCommand(command: IPrintStacksCommandArgs): Promise<void> {
        ...
        const template = UpdateNunjucksCommand.createTemplateUsingOverrides(command as IUpdateNunjucksCommandArgs, command.templateFile);
